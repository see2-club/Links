  ...
  return (
    <div
      className={cn(
        ...
        className,
        {
          "hover:border-2 hover:border-[var(--color-one)] hover:dark:border-[var(--color-one)]": true,
        }
      )}
    >
      <Image
...
export const BentoGridItem = ({
  ...
  return (
    <div
      // className={cn(
      //   "row-span-1  group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-blue-50/20  justify-between flex flex-col space-y-4 rounded-[28px] border border-black/5",
      //   className
      // )}
      className={cn(
        "row-span-1  group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/[0.2] bg-blue-50/20  justify-between flex flex-col space-y-4 rounded-[28px] border border-black/5",
...
export const BentoGridItemCta = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1  group/bento hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4  justify-between flex flex-col space-y-4 rounded-[28px] border border-black/5",
        className,
        {
          "bg-[#131313] hover:border-2 hover:border-[var(--color-one)] hover:dark:border-[var(--color-one)]": true,
        }
      )}
    >
      {header}
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        {icon}
        <div className="font-sans font-bold  text-blue-100 mb-2 mt-2">
          {title}
        </div>
